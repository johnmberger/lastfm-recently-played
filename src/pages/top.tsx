...
export default function TopsPage({
  ...
  const periodLabel = periodControlLabel(period);
  ...
  return (
    <>
      <MetaTags
        ...
        ogTitle={`${pageTitle} | earworms`}
        ogDescription={`top artists, albums, and tracks — currently showing ${periodLabel}.`}
        ogUrl="/top"
        twitterTitle={`${pageTitle} | earworms`}
        twitterDescription={`top artists, albums, and tracks — currently showing ${periodLabel}.`}
      />
